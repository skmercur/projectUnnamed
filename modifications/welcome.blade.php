...
<img src="{{ Auth::user()->imgpath}}" alt="" style="height: 40px;">
    ...
    <form action="search" style="margin-top: 15px;" method="get">
     <div class="container"> 
        <div class="row">
        <div class="col-sm-12">
                <img src="{{asset('assets/img/logo.png')}}" class="img-fluid" style="margin-left: auto;
	margin-right: auto;
	display: block;max-height: 360px;">
        ...
        <div class="col-sm-12">
                <div class="input-group mb-12 center">
                         <input type="text" class="form-control form-control-lg" style="margin-left: 15%; margin-bottom: 1%;margin-right: 15%;height:2%;" placeholder="type here to search for documents" name="q">
                        <!-- <input type="hidden" name="_token" value="{{csrf_token()}}" /> -->
                </div>
         </div>
         <div class="col-sm-12">
                    <div class="input-group" >
                            <button class="form-control btn btn-success" style=" margin-bottom: 10%;margin-left: 30%;margin-right: 30%;height:;height: 1%;" type="submit" id="button-addon2">Search</button>
                    </div>
         </div>          
        </div>
       </div>
