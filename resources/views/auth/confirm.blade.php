...
<div class="alert alert-success" role="alert" style="margin-left: 15%;margin-top: 5%;margin-right:  15%;">
  ...
  <p>You successfully Register. Check you inbox for the activation code.</p>
  <hr>
  <p class="mb-0">Hint if you don't find it in the inbox it might be in the spam folder.</p>
</div>
